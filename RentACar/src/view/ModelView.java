...
public class ModelView extends Layout{
    ...
    public ModelView(Model model) {
        ...
        if (this.model.getId() != 0){
            ...
            ComboItem defaultBrandComboItem = new ComboItem(this.model.getBrand().getId(), this.model.getBrand().getName());
            this.cmb_brand.getModel().setSelectedItem(defaultBrandComboItem);
        }
